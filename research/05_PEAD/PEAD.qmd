...
abstract: |
  Rather than assess equity returns from a traditional chronological perspective, the below looks at equity returns in relation to each company's earnings release date. In doing so, I have identified two idiosyncrasies that occur in the markets: 
