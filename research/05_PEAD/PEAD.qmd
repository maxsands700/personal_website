...
However, it is important to note that in the above, I calculated daily returns from close to close between consecutive days, which implicitly includes price changes that occur during after-hours trading. Typically, companies release earnings after-hours (to avoid issuing a trading halt during normal trading hours), and therefore it is important to identify how much of these returns occur after-hours.

To do this I have plotted the average high, open, low, and close of companies for 5 days before an earnings announcement until 5 days after earnings release. The data is indexed with the first open occurring at \$1, and I have bucketed the data into 9 groups according to nominal earnings surprise (rather than into 10 groups for visual appeal):

![](images/intraday_image.png){fig-align="center" width="2400"}

As we can see from the above, much of the alpha generated after earnings announcements occur during after-hours trading. This is logical, as we expect the quantitative firms, with fast computers, to capitalize on new information as quickly as possible.
...
Under these conditions, our trading strategy yields strong returns.
