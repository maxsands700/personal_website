...
r3000_nested %>% 
    ...
    labs(x = "", y = "", title = "Median Price-to-Sales", color = "", fill = "Ann. Sector ETF Return") +
...
`Get constituent price data from Bloomberg and overlay color scale returns for each Sector Level 3...`
...
`Analysis of interest rates and T10 - T2, etc...`
