...
It is important to note that our IPO metric can take on extreme values at the sector level - *Health Care* in 2001 and *Financials* (w/ the SPAC curge) in 2021. Because these extreme points reduce the relative importance of other time periods, we will water them down and keep this in the back of our minds going forward.
...
The ability to time market bubbles is nearly impossible, but the main indicators I would pay attention to are interest rates; since a large part of bubbles are caused by debt, it is logical that the cost of borrowing money is highly relevant.
